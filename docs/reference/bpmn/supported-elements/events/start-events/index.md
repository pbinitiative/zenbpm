...
<table className="bpmn-types-table">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="./none-start-event"><img className="bpmn-supported" src="/img/bpmn/events/none-start.svg" alt="None Start Event" height="70" /></a></td>
      <td>Explicit API call or internal trigger — no event definition</td>
    </tr>
    <tr>
      <td><a href="./message-start-event">Message</a></td>
      <td><a href="./message-start-event"><img className="bpmn-supported" src="/img/bpmn/events/message-start.svg" alt="Message Start Event" height="70" /></a></td>
      <td>A named message is received by the engine</td>
    </tr>
    <tr>
      <td><a href="./timer-start-event">Timer</a></td>
      <td><a href="./timer-start-event"><img className="bpmn-supported" src="/img/bpmn/events/timer-start.svg" alt="Timer Start Event" height="70" /></a></td>
