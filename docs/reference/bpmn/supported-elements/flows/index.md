...
<table className="bpmn-types-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="./conditional-flow"><img className="bpmn-supported" src={require('!url-loader!../../../assets/bpmn/flows/conditional-flow.svg').default} alt="Conditional Flow" height="50" /></a></td>
    ...
    <tr>
      <td>Message flow</td>
      <td><img src={require('!url-loader!../../../assets/bpmn/flows/message-flow.svg').default} alt="Message Flow" height="50" /></td>
    ...
    <tr>
      ...
      <td><img src={require('!url-loader!../../../assets/bpmn/flows/data-association.svg').default} alt="Data Association" height="50" /></td>
