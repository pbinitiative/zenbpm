...
<table className="bpmn-types-table">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="./data-store-reference"><img className="bpmn-supported" src="/img/bpmn/others/data-store-reference.svg" alt="Data Store Reference" height="70" /></a></td>
    ...
    <tr>
      ...
      <td><a href="./data-object-reference"><img className="bpmn-supported" src="/img/bpmn/others/data-object-reference.svg" alt="Data Object Reference" height="70" /></a></td>
    ...
    <tr>
      ...
      <td><a href="./expanded-pool"><img className="bpmn-supported" src="/img/bpmn/others/expanded-pool.svg" alt="Expanded Pool" height="70" /></a></td>
    ...
    <tr>
      ...
      <td><a href="./empty-pool"><img className="bpmn-supported" src="/img/bpmn/others/empty-pool.svg" alt="Empty Pool" height="70" /></a></td>
