...
var file_zen_cluster_proto_rawDesc = string([]byte{
	...
	0xb4, 0x02, 0x0a, 0x13, 0x4e, 0x6f, 0x64, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x52,
	...
	0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x48, 0x01, 0x52, 0x05,
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x88, 0x01, 0x01, 0x12, 0x2c, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65,
	...
	0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x1b, 0x0a, 0x19, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65,
	...
	0x64, 0x65, 0x50, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xd9, 0x15, 0x0a, 0x0a, 0x5a, 0x65,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x40, 0x0a, 0x0b, 0x4e, 0x6f, 0x64, 0x65, 0x43,
	...
	0x2f, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06,
...
var file_zen_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 80)
var file_zen_cluster_proto_goTypes = []any{
	...
	(*PartitionRestoreRequest)(nil),            // 64: cluster.PartitionRestoreRequest
	(*PartitionRestoreResponse)(nil),           // 65: cluster.PartitionRestoreResponse
	(*PartitionBackupRequest)(nil),             // 66: cluster.PartitionBackupRequest
	(*PartitionBackupResponse)(nil),            // 67: cluster.PartitionBackupResponse
	(*UnassignPartitionRequest)(nil),           // 68: cluster.UnassignPartitionRequest
	(*UnassignPartitionResponse)(nil),          // 69: cluster.UnassignPartitionResponse
	(*AssignPartitionRequest)(nil),             // 70: cluster.AssignPartitionRequest
	(*AssignPartitionResponse)(nil),            // 71: cluster.AssignPartitionResponse
	(*ConfigurationUpdateRequest)(nil),         // 72: cluster.ConfigurationUpdateRequest
	(*ConfigurationUpdateResponse)(nil),        // 73: cluster.ConfigurationUpdateResponse
	(*ClusterRestoreRequest)(nil),              // 74: cluster.ClusterRestoreRequest
	(*ClusterRestoreResponse)(nil),             // 75: cluster.ClusterRestoreResponse
	(*ClusterBackupRequest)(nil),               // 76: cluster.ClusterBackupRequest
	(*ClusterBackupResponse)(nil),              // 77: cluster.ClusterBackupResponse
	(*NodeCommandResponse)(nil),                // 78: cluster.NodeCommandResponse
	(*ClusterNodeChangeResponse)(nil),          // 79: cluster.ClusterNodeChangeResponse
	(*ClusterNodePartitionChangeResponse)(nil), // 80: cluster.ClusterNodePartitionChangeResponse
	(proto.Command_Type)(0),                    // 81: zencommand.Command.Type
	(*proto.Command)(nil),                      // 82: zencommand.Command
}
var file_zen_cluster_proto_depIdxs = []int32{
	...
	1,  // 39: cluster.NodeCommandResponse.error:type_name -> cluster.ErrorResult
	81, // 40: cluster.NodeCommandResponse.type:type_name -> zencommand.Command.Type
	79, // 41: cluster.NodeCommandResponse.node_change:type_name -> cluster.ClusterNodeChangeResponse
	80, // 42: cluster.NodeCommandResponse.node_partition_change:type_name -> cluster.ClusterNodePartitionChangeResponse
	2,  // 43: cluster.ZenService.Notify:input_type -> cluster.NotifyRequest
	4,  // 44: cluster.ZenService.Join:input_type -> cluster.JoinRequest
	6,  // 45: cluster.ZenService.AddPartitionNode:input_type -> cluster.AddPartitionNodeRequest
	8,  // 46: cluster.ZenService.ShutdownPartitionNode:input_type -> cluster.ShutdownPartitionNodeRequest
	10, // 47: cluster.ZenService.PartitionNodeLeaderChange:input_type -> cluster.PartitionNodeLeaderChangeRequest
	12, // 48: cluster.ZenService.RemovePartitionNode:input_type -> cluster.RemovePartitionNodeRequest
	14, // 49: cluster.ZenService.ResumePartitionNode:input_type -> cluster.ResumePartitionNodeRequest
	76, // 50: cluster.ZenService.ClusterBackup:input_type -> cluster.ClusterBackupRequest
	74, // 51: cluster.ZenService.ClusterRestore:input_type -> cluster.ClusterRestoreRequest
	72, // 52: cluster.ZenService.ConfigurationUpdate:input_type -> cluster.ConfigurationUpdateRequest
	70, // 53: cluster.ZenService.AssignPartition:input_type -> cluster.AssignPartitionRequest
	68, // 54: cluster.ZenService.UnassignPartition:input_type -> cluster.UnassignPartitionRequest
	66, // 55: cluster.ZenService.PartitionBackup:input_type -> cluster.PartitionBackupRequest
	64, // 56: cluster.ZenService.PartitionRestore:input_type -> cluster.PartitionRestoreRequest
	82, // 57: cluster.ZenService.NodeCommand:input_type -> zencommand.Command
	16, // 58: cluster.ZenService.EvaluateDecision:input_type -> cluster.EvaluateDecisionRequest
	29, // 59: cluster.ZenService.DeployDecisionDefinition:input_type -> cluster.DeployDecisionDefinitionRequest
	31, // 60: cluster.ZenService.DeployProcessDefinition:input_type -> cluster.DeployProcessDefinitionRequest
	37, // 61: cluster.ZenService.ActivateJob:input_type -> cluster.ActivateJobRequest
	40, // 62: cluster.ZenService.PublishMessage:input_type -> cluster.PublishMessageRequest
	42, // 63: cluster.ZenService.CreateInstance:input_type -> cluster.CreateInstanceRequest
	44, // 64: cluster.ZenService.GetProcessInstances:input_type -> cluster.GetProcessInstancesRequest
	55, // 65: cluster.ZenService.GetJobs:input_type -> cluster.GetJobsRequest
	47, // 66: cluster.ZenService.GetProcessInstance:input_type -> cluster.GetProcessInstanceRequest
	49, // 67: cluster.ZenService.GetProcessInstanceJobs:input_type -> cluster.GetProcessInstanceJobsRequest
	51, // 68: cluster.ZenService.GetFlowElementHistory:input_type -> cluster.GetFlowElementHistoryRequest
	53, // 69: cluster.ZenService.GetIncidents:input_type -> cluster.GetIncidentsRequest
	58, // 70: cluster.ZenService.ResolveIncident:input_type -> cluster.ResolveIncidentRequest
	60, // 71: cluster.ZenService.SubscribeJob:input_type -> cluster.SubscribeJobRequest
	33, // 72: cluster.ZenService.CompleteJob:input_type -> cluster.CompleteJobRequest
	35, // 73: cluster.ZenService.FailJob:input_type -> cluster.FailJobRequest
	62, // 74: cluster.ZenService.ReassignJob:input_type -> cluster.ReassignJobRequest
	3,  // 75: cluster.ZenService.Notify:output_type -> cluster.NotifyResponse
	5,  // 76: cluster.ZenService.Join:output_type -> cluster.JoinResponse
	7,  // 77: cluster.ZenService.AddPartitionNode:output_type -> cluster.AddPartitionNodeResponse
	9,  // 78: cluster.ZenService.ShutdownPartitionNode:output_type -> cluster.ShutdownPartitionNodeResponse
	11, // 79: cluster.ZenService.PartitionNodeLeaderChange:output_type -> cluster.PartitionNodeLeaderChangeResponse
	13, // 80: cluster.ZenService.RemovePartitionNode:output_type -> cluster.RemovePartitionNodeResponse
	15, // 81: cluster.ZenService.ResumePartitionNode:output_type -> cluster.ResumePartitionNodeResponse
	77, // 82: cluster.ZenService.ClusterBackup:output_type -> cluster.ClusterBackupResponse
	75, // 83: cluster.ZenService.ClusterRestore:output_type -> cluster.ClusterRestoreResponse
	73, // 84: cluster.ZenService.ConfigurationUpdate:output_type -> cluster.ConfigurationUpdateResponse
	71, // 85: cluster.ZenService.AssignPartition:output_type -> cluster.AssignPartitionResponse
	69, // 86: cluster.ZenService.UnassignPartition:output_type -> cluster.UnassignPartitionResponse
	67, // 87: cluster.ZenService.PartitionBackup:output_type -> cluster.PartitionBackupResponse
	65, // 88: cluster.ZenService.PartitionRestore:output_type -> cluster.PartitionRestoreResponse
	78, // 89: cluster.ZenService.NodeCommand:output_type -> cluster.NodeCommandResponse
	17, // 90: cluster.ZenService.EvaluateDecision:output_type -> cluster.EvaluatedDRDResult
	30, // 91: cluster.ZenService.DeployDecisionDefinition:output_type -> cluster.DeployDecisionDefinitionResponse
	32, // 92: cluster.ZenService.DeployProcessDefinition:output_type -> cluster.DeployProcessDefinitionResponse
	38, // 93: cluster.ZenService.ActivateJob:output_type -> cluster.ActivateJobResponse
	41, // 94: cluster.ZenService.PublishMessage:output_type -> cluster.PublishMessageResponse
	43, // 95: cluster.ZenService.CreateInstance:output_type -> cluster.CreateInstanceResponse
	46, // 96: cluster.ZenService.GetProcessInstances:output_type -> cluster.GetProcessInstancesResponse
	57, // 97: cluster.ZenService.GetJobs:output_type -> cluster.GetJobsResponse
	48, // 98: cluster.ZenService.GetProcessInstance:output_type -> cluster.GetProcessInstanceResponse
	50, // 99: cluster.ZenService.GetProcessInstanceJobs:output_type -> cluster.GetProcessInstanceJobsResponse
	52, // 100: cluster.ZenService.GetFlowElementHistory:output_type -> cluster.GetFlowElementHistoryResponse
	54, // 101: cluster.ZenService.GetIncidents:output_type -> cluster.GetIncidentsResponse
	59, // 102: cluster.ZenService.ResolveIncident:output_type -> cluster.ResolveIncidentResponse
	61, // 103: cluster.ZenService.SubscribeJob:output_type -> cluster.SubscribeJobResponse
	34, // 104: cluster.ZenService.CompleteJob:output_type -> cluster.CompleteJobResponse
	36, // 105: cluster.ZenService.FailJob:output_type -> cluster.FailJobResponse
	63, // 106: cluster.ZenService.ReassignJob:output_type -> cluster.ReassignJobResponse
...
func file_zen_cluster_proto_init() {
	...
	file_zen_cluster_proto_msgTypes[77].OneofWrappers = []any{
