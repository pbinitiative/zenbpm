...
func (SubscribeJobRequest_Type) EnumDescriptor() ([]byte, []int) {
	return file_zen_cluster_proto_rawDescGZIP(), []int{59, 0}
}
...
var file_zen_cluster_proto_rawDesc = string([]byte{
	...
	0x65, 0x64, 0x41, 0x74, 0x22, 0x6c, 0x0a, 0x15, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a,
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x6b, 0x65,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xfb, 0x16, 0x0a, 0x0a, 0x5a, 0x65, 0x6e,
...
var file_zen_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 83)
var file_zen_cluster_proto_goTypes = []any{
	...
	(*PublishMessageRequest)(nil),              // 40: cluster.PublishMessageRequest
	(*PublishMessageResponse)(nil),             // 41: cluster.PublishMessageResponse
	(*CreateInstanceRequest)(nil),              // 42: cluster.CreateInstanceRequest
	(*CreateInstanceResponse)(nil),             // 43: cluster.CreateInstanceResponse
	(*GetProcessInstancesRequest)(nil),         // 44: cluster.GetProcessInstancesRequest
	(*PartitionedProcessInstances)(nil),        // 45: cluster.PartitionedProcessInstances
	(*GetProcessInstancesResponse)(nil),        // 46: cluster.GetProcessInstancesResponse
	(*GetProcessInstanceRequest)(nil),          // 47: cluster.GetProcessInstanceRequest
	(*GetProcessInstanceResponse)(nil),         // 48: cluster.GetProcessInstanceResponse
	(*GetProcessInstanceJobsRequest)(nil),      // 49: cluster.GetProcessInstanceJobsRequest
	(*GetProcessInstanceJobsResponse)(nil),     // 50: cluster.GetProcessInstanceJobsResponse
	(*GetFlowElementHistoryRequest)(nil),       // 51: cluster.GetFlowElementHistoryRequest
	(*GetFlowElementHistoryResponse)(nil),      // 52: cluster.GetFlowElementHistoryResponse
	(*GetIncidentsRequest)(nil),                // 53: cluster.GetIncidentsRequest
	(*GetIncidentsResponse)(nil),               // 54: cluster.GetIncidentsResponse
	(*GetJobsRequest)(nil),                     // 55: cluster.GetJobsRequest
	(*PartitionedJobs)(nil),                    // 56: cluster.PartitionedJobs
	(*GetJobsResponse)(nil),                    // 57: cluster.GetJobsResponse
	(*ResolveIncidentRequest)(nil),             // 58: cluster.ResolveIncidentRequest
	(*ResolveIncidentResponse)(nil),            // 59: cluster.ResolveIncidentResponse
	(*SubscribeJobRequest)(nil),                // 60: cluster.SubscribeJobRequest
	(*SubscribeJobResponse)(nil),               // 61: cluster.SubscribeJobResponse
	(*ReassignJobRequest)(nil),                 // 62: cluster.ReassignJobRequest
	(*ReassignJobResponse)(nil),                // 63: cluster.ReassignJobResponse
	(*CpuProfilerRequest)(nil),                 // 64: cluster.CpuProfilerRequest
	(*CpuProfilerStartResult)(nil),             // 65: cluster.CpuProfilerStartResult
	(*CpuProfilerStopResult)(nil),              // 66: cluster.CpuProfilerStopResult
	(*PartitionRestoreRequest)(nil),            // 67: cluster.PartitionRestoreRequest
	(*PartitionRestoreResponse)(nil),           // 68: cluster.PartitionRestoreResponse
	(*PartitionBackupRequest)(nil),             // 69: cluster.PartitionBackupRequest
	(*PartitionBackupResponse)(nil),            // 70: cluster.PartitionBackupResponse
	(*UnassignPartitionRequest)(nil),           // 71: cluster.UnassignPartitionRequest
	(*UnassignPartitionResponse)(nil),          // 72: cluster.UnassignPartitionResponse
	(*AssignPartitionRequest)(nil),             // 73: cluster.AssignPartitionRequest
	(*AssignPartitionResponse)(nil),            // 74: cluster.AssignPartitionResponse
	(*ConfigurationUpdateRequest)(nil),         // 75: cluster.ConfigurationUpdateRequest
	(*ConfigurationUpdateResponse)(nil),        // 76: cluster.ConfigurationUpdateResponse
	(*ClusterRestoreRequest)(nil),              // 77: cluster.ClusterRestoreRequest
	(*ClusterRestoreResponse)(nil),             // 78: cluster.ClusterRestoreResponse
	(*ClusterBackupRequest)(nil),               // 79: cluster.ClusterBackupRequest
	(*ClusterBackupResponse)(nil),              // 80: cluster.ClusterBackupResponse
	(*NodeCommandResponse)(nil),                // 81: cluster.NodeCommandResponse
	(*ClusterNodeChangeResponse)(nil),          // 82: cluster.ClusterNodeChangeResponse
	(*ClusterNodePartitionChangeResponse)(nil), // 83: cluster.ClusterNodePartitionChangeResponse
	(proto.Command_Type)(0),                    // 84: zencommand.Command.Type
	(*proto.Command)(nil),                      // 85: zencommand.Command
}
var file_zen_cluster_proto_depIdxs = []int32{
	...
	1,  // 18: cluster.PublishMessageResponse.error:type_name -> cluster.ErrorResult
	1,  // 19: cluster.CreateInstanceResponse.error:type_name -> cluster.ErrorResult
	25, // 20: cluster.CreateInstanceResponse.process:type_name -> cluster.ProcessInstance
	25, // 21: cluster.PartitionedProcessInstances.instances:type_name -> cluster.ProcessInstance
	1,  // 22: cluster.GetProcessInstancesResponse.error:type_name -> cluster.ErrorResult
	45, // 23: cluster.GetProcessInstancesResponse.partitions:type_name -> cluster.PartitionedProcessInstances
	1,  // 24: cluster.GetProcessInstanceResponse.error:type_name -> cluster.ErrorResult
	25, // 25: cluster.GetProcessInstanceResponse.processes:type_name -> cluster.ProcessInstance
	1,  // 26: cluster.GetProcessInstanceJobsResponse.error:type_name -> cluster.ErrorResult
	26, // 27: cluster.GetProcessInstanceJobsResponse.jobs:type_name -> cluster.Job
	1,  // 28: cluster.GetFlowElementHistoryResponse.error:type_name -> cluster.ErrorResult
	27, // 29: cluster.GetFlowElementHistoryResponse.flow:type_name -> cluster.FlowElement
	1,  // 30: cluster.GetIncidentsResponse.error:type_name -> cluster.ErrorResult
	28, // 31: cluster.GetIncidentsResponse.incidents:type_name -> cluster.Incident
	26, // 32: cluster.PartitionedJobs.jobs:type_name -> cluster.Job
	1,  // 33: cluster.GetJobsResponse.error:type_name -> cluster.ErrorResult
	56, // 34: cluster.GetJobsResponse.partitions:type_name -> cluster.PartitionedJobs
	1,  // 35: cluster.ResolveIncidentResponse.error:type_name -> cluster.ErrorResult
	0,  // 36: cluster.SubscribeJobRequest.type:type_name -> cluster.SubscribeJobRequest.Type
	39, // 37: cluster.SubscribeJobResponse.job:type_name -> cluster.InternalJob
	1,  // 38: cluster.ReassignJobResponse.error:type_name -> cluster.ErrorResult
	1,  // 39: cluster.CpuProfilerStartResult.error:type_name -> cluster.ErrorResult
	1,  // 40: cluster.CpuProfilerStopResult.error:type_name -> cluster.ErrorResult
	1,  // 41: cluster.NodeCommandResponse.error:type_name -> cluster.ErrorResult
	84, // 42: cluster.NodeCommandResponse.type:type_name -> zencommand.Command.Type
	82, // 43: cluster.NodeCommandResponse.node_change:type_name -> cluster.ClusterNodeChangeResponse
	83, // 44: cluster.NodeCommandResponse.node_partition_change:type_name -> cluster.ClusterNodePartitionChangeResponse
	2,  // 45: cluster.ZenService.Notify:input_type -> cluster.NotifyRequest
	4,  // 46: cluster.ZenService.Join:input_type -> cluster.JoinRequest
	6,  // 47: cluster.ZenService.AddPartitionNode:input_type -> cluster.AddPartitionNodeRequest
	8,  // 48: cluster.ZenService.ShutdownPartitionNode:input_type -> cluster.ShutdownPartitionNodeRequest
	10, // 49: cluster.ZenService.PartitionNodeLeaderChange:input_type -> cluster.PartitionNodeLeaderChangeRequest
	12, // 50: cluster.ZenService.RemovePartitionNode:input_type -> cluster.RemovePartitionNodeRequest
	14, // 51: cluster.ZenService.ResumePartitionNode:input_type -> cluster.ResumePartitionNodeRequest
	79, // 52: cluster.ZenService.ClusterBackup:input_type -> cluster.ClusterBackupRequest
	77, // 53: cluster.ZenService.ClusterRestore:input_type -> cluster.ClusterRestoreRequest
	75, // 54: cluster.ZenService.ConfigurationUpdate:input_type -> cluster.ConfigurationUpdateRequest
	73, // 55: cluster.ZenService.AssignPartition:input_type -> cluster.AssignPartitionRequest
	71, // 56: cluster.ZenService.UnassignPartition:input_type -> cluster.UnassignPartitionRequest
	69, // 57: cluster.ZenService.PartitionBackup:input_type -> cluster.PartitionBackupRequest
	67, // 58: cluster.ZenService.PartitionRestore:input_type -> cluster.PartitionRestoreRequest
	64, // 59: cluster.ZenService.StartCpuProfiler:input_type -> cluster.CpuProfilerRequest
	64, // 60: cluster.ZenService.StopCpuProfiler:input_type -> cluster.CpuProfilerRequest
	85, // 61: cluster.ZenService.NodeCommand:input_type -> zencommand.Command
	16, // 62: cluster.ZenService.EvaluateDecision:input_type -> cluster.EvaluateDecisionRequest
	29, // 63: cluster.ZenService.DeployDecisionDefinition:input_type -> cluster.DeployDecisionDefinitionRequest
	31, // 64: cluster.ZenService.DeployProcessDefinition:input_type -> cluster.DeployProcessDefinitionRequest
	37, // 65: cluster.ZenService.ActivateJob:input_type -> cluster.ActivateJobRequest
	40, // 66: cluster.ZenService.PublishMessage:input_type -> cluster.PublishMessageRequest
	42, // 67: cluster.ZenService.CreateInstance:input_type -> cluster.CreateInstanceRequest
	44, // 68: cluster.ZenService.GetProcessInstances:input_type -> cluster.GetProcessInstancesRequest
	55, // 69: cluster.ZenService.GetJobs:input_type -> cluster.GetJobsRequest
	47, // 70: cluster.ZenService.GetProcessInstance:input_type -> cluster.GetProcessInstanceRequest
	49, // 71: cluster.ZenService.GetProcessInstanceJobs:input_type -> cluster.GetProcessInstanceJobsRequest
	51, // 72: cluster.ZenService.GetFlowElementHistory:input_type -> cluster.GetFlowElementHistoryRequest
	53, // 73: cluster.ZenService.GetIncidents:input_type -> cluster.GetIncidentsRequest
	58, // 74: cluster.ZenService.ResolveIncident:input_type -> cluster.ResolveIncidentRequest
	60, // 75: cluster.ZenService.SubscribeJob:input_type -> cluster.SubscribeJobRequest
	33, // 76: cluster.ZenService.CompleteJob:input_type -> cluster.CompleteJobRequest
	35, // 77: cluster.ZenService.FailJob:input_type -> cluster.FailJobRequest
	62, // 78: cluster.ZenService.ReassignJob:input_type -> cluster.ReassignJobRequest
	3,  // 79: cluster.ZenService.Notify:output_type -> cluster.NotifyResponse
	5,  // 80: cluster.ZenService.Join:output_type -> cluster.JoinResponse
	7,  // 81: cluster.ZenService.AddPartitionNode:output_type -> cluster.AddPartitionNodeResponse
	9,  // 82: cluster.ZenService.ShutdownPartitionNode:output_type -> cluster.ShutdownPartitionNodeResponse
	11, // 83: cluster.ZenService.PartitionNodeLeaderChange:output_type -> cluster.PartitionNodeLeaderChangeResponse
	13, // 84: cluster.ZenService.RemovePartitionNode:output_type -> cluster.RemovePartitionNodeResponse
	15, // 85: cluster.ZenService.ResumePartitionNode:output_type -> cluster.ResumePartitionNodeResponse
	80, // 86: cluster.ZenService.ClusterBackup:output_type -> cluster.ClusterBackupResponse
	78, // 87: cluster.ZenService.ClusterRestore:output_type -> cluster.ClusterRestoreResponse
	76, // 88: cluster.ZenService.ConfigurationUpdate:output_type -> cluster.ConfigurationUpdateResponse
	74, // 89: cluster.ZenService.AssignPartition:output_type -> cluster.AssignPartitionResponse
	72, // 90: cluster.ZenService.UnassignPartition:output_type -> cluster.UnassignPartitionResponse
	70, // 91: cluster.ZenService.PartitionBackup:output_type -> cluster.PartitionBackupResponse
	68, // 92: cluster.ZenService.PartitionRestore:output_type -> cluster.PartitionRestoreResponse
	65, // 93: cluster.ZenService.StartCpuProfiler:output_type -> cluster.CpuProfilerStartResult
	66, // 94: cluster.ZenService.StopCpuProfiler:output_type -> cluster.CpuProfilerStopResult
	81, // 95: cluster.ZenService.NodeCommand:output_type -> cluster.NodeCommandResponse
	17, // 96: cluster.ZenService.EvaluateDecision:output_type -> cluster.EvaluatedDRDResult
	30, // 97: cluster.ZenService.DeployDecisionDefinition:output_type -> cluster.DeployDecisionDefinitionResponse
	32, // 98: cluster.ZenService.DeployProcessDefinition:output_type -> cluster.DeployProcessDefinitionResponse
	38, // 99: cluster.ZenService.ActivateJob:output_type -> cluster.ActivateJobResponse
	41, // 100: cluster.ZenService.PublishMessage:output_type -> cluster.PublishMessageResponse
	43, // 101: cluster.ZenService.CreateInstance:output_type -> cluster.CreateInstanceResponse
	46, // 102: cluster.ZenService.GetProcessInstances:output_type -> cluster.GetProcessInstancesResponse
	57, // 103: cluster.ZenService.GetJobs:output_type -> cluster.GetJobsResponse
	48, // 104: cluster.ZenService.GetProcessInstance:output_type -> cluster.GetProcessInstanceResponse
	50, // 105: cluster.ZenService.GetProcessInstanceJobs:output_type -> cluster.GetProcessInstanceJobsResponse
	52, // 106: cluster.ZenService.GetFlowElementHistory:output_type -> cluster.GetFlowElementHistoryResponse
	54, // 107: cluster.ZenService.GetIncidents:output_type -> cluster.GetIncidentsResponse
	59, // 108: cluster.ZenService.ResolveIncident:output_type -> cluster.ResolveIncidentResponse
	61, // 109: cluster.ZenService.SubscribeJob:output_type -> cluster.SubscribeJobResponse
	34, // 110: cluster.ZenService.CompleteJob:output_type -> cluster.CompleteJobResponse
	36, // 111: cluster.ZenService.FailJob:output_type -> cluster.FailJobResponse
	63, // 112: cluster.ZenService.ReassignJob:output_type -> cluster.ReassignJobResponse
...
func file_zen_cluster_proto_init() {
	...
	file_zen_cluster_proto_msgTypes[80].OneofWrappers = []any{
