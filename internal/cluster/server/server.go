...
func (s *Server) GetProcessInstanceTimerSubscriptions(ctx context.Context, req *proto.GetProcessInstanceTimerSubscriptionsRequest) (*proto.GetProcessInstanceTimerSubscriptionsResponse, error) {
	...
	timerStateFilter, err := activityStateToTimerState(req.State)
	if err != nil {
		e := zenerr.TechnicalError(err)
...
func (s *Server) GetProcessInstanceErrorSubscriptions(ctx context.Context, req *proto.GetProcessInstanceErrorSubscriptionsRequest) (*proto.GetProcessInstanceErrorSubscriptionsResponse, error) {
	...
	errorStateFilter, err := activityStateToErrorState(req.State)
	if err != nil {
		e := zenerr.TechnicalError(err)
...
func activityStateToTimerState(activityState *int64) (*int64, error) {
	if activityState == nil {
		return nil, nil
	}
	switch runtime.ActivityState(*activityState) {
	case runtime.ActivityStateActive:
		return ptr.To(int64(runtime.TimerStateCreated)), nil
	case runtime.ActivityStateCompleted:
		return ptr.To(int64(runtime.TimerStateTriggered)), nil
	case runtime.ActivityStateWithdrawn:
		return ptr.To(int64(runtime.TimerStateCancelled)), nil
	default:
		log.Error("activityStateToTimerState: unrecognized ActivityState %d; filtering disabled", *activityState)
		return nil, fmt.Errorf("unrecognized ActivityState %d for timer filter", *activityState)
	}
}
...
func activityStateToErrorState(activityState *int64) (*int64, error) {
	if activityState == nil {
		return nil, nil
	}
	switch runtime.ActivityState(*activityState) {
	case runtime.ActivityStateActive:
		return ptr.To(int64(runtime.ErrorStateCreated)), nil
	case runtime.ActivityStateWithdrawn:
		return ptr.To(int64(runtime.ErrorStateCancelled)), nil
	default:
		log.Error("activityStateToErrorState: unrecognized ActivityState %d; filtering disabled", *activityState)
		return nil, fmt.Errorf("unrecognized ActivityState %d for error filter", *activityState)
	}
}
