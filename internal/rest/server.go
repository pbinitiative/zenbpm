...
func (s *Server) GetProcessInstanceMessageSubscriptions(ctx context.Context, request public.GetProcessInstanceMessageSubscriptionsRequestObject) (public.GetProcessInstanceMessageSubscriptionsResponseObject, error) {
	...
	stateInt := eventSubscriptionStateToInt64(request.Params.State)
...
// eventSubscriptionStateToInt64 converts a REST EventSubscriptionState to its ActivityState int64.
func eventSubscriptionStateToInt64(p *public.EventSubscriptionState) *int64 {
	if p == nil {
		return nil
	}
	var v int64
...
// activityStateToEventSubscriptionState converts an ActivityState to a REST EventSubscriptionState.
