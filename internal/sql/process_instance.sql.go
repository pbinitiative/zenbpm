...
SELECT
    "key", process_definition_key, created_at, state, variables, parent_process_execution_token, target_parent_activity_id, history_ttl_sec, history_delete_sec
FROM
    process_instance
WHERE
