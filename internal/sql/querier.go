...
type Querier interface {
	...
	FindBusinessRuleExecutionByKey(ctx context.Context, key int64) (BusinessRuleExecution, error)
	...
	SaveBusinessRuleExecution(ctx context.Context, arg SaveBusinessRuleExecutionParams) error
