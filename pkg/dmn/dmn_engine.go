...
func (engine *ZenDmnEngine) evaluateDRD(
	...
	// TODO save here to business_rule_execution
	...
	businessRuleExecutionKey := engine.generateKey()
	err = engine.persistence.SaveBusinessRuleExecution(ctx, runtime.BusinessRuleExecution{
		Key:                businessRuleExecutionKey,
	...
	return &EvaluatedDRDResult{
		...
		BusinessRuleExecutionKey: businessRuleExecutionKey,
	}, nil
}
