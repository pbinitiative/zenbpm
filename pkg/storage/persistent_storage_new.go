...
type ProcessDefinitionStorage interface {
...
type JobStorage interface {
	...
	// FindJobByElementID returns Job by given process instance key and element instance key
	FindJobByElementID(ctx context.Context, processInstanceKey int64, elementID string) (runtime.Job, error)

	// FindActiveJobsByType returns list of active jobs for given job type
...
type MessageStorage interface {
	...
	FindActivityMessageSubscription(ctx context.Context, activityKey int64, state runtime.ActivityState) ([]runtime.MessageSubscription, error)

	// FindMessageSubscription return zero or many message subscriptions by given params
	FindMessageSubscription(ctx context.Context, originActivityKey int64, processInstanceKey int64, state runtime.ActivityState) ([]runtime.MessageSubscription, error)
