...
type DecisionStorage interface {
	...
	BusinessRuleExecutionStorageReader
	BusinessRuleExecutionStorageWriter
...
type BusinessRuleExecutionStorageWriter interface {
	SaveBusinessRuleExecution(ctx context.Context, result dmnruntime.BusinessRuleExecution) error
}

type BusinessRuleExecutionStorageReader interface {
	FindBusinessRuleExecutionByKey(ctx context.Context, key int64) (dmnruntime.BusinessRuleExecution, error)
}
