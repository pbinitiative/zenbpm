...
type DecisionStorage interface {
	...
	BusinessRuleTaskStorageReader
	BusinessRuleTaskStorageWriter
...
type BusinessRuleTaskStorageWriter interface {
	SaveBusinessRuleTask(ctx context.Context, result bpmnruntime.BusinessRuleTask) error
}

type BusinessRuleTaskStorageReader interface {
	FindBusinessRuleTasksByExecutionTokenIds(ctx context.Context, executionTokenIds []int64) ([]bpmnruntime.BusinessRuleTask, error)
}
