...
func TestRestJobFailOnSubProcess(t *testing.T) {
	...
	t.Run("nested_matched_error_is_caught_and_propagates_all_variables_to_catching_scope", func(t *testing.T) {
		...
		assertProcessInstanceVariables(t, serviceTaskProcess.Key, map[string]any{})
		...
		assertProcessInstanceVariables(t, secondChildProcess.Key, map[string]any{})
		...
		assertProcessInstanceVariables(t, firstChildProcess.Key, map[string]interface{}{"variable_from_request": "request_variable"})
