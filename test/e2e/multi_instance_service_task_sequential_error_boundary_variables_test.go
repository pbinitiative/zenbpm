...
func TestSequentialMultiInstanceErrorBoundaryVariables(t *testing.T) {
	t.Run("Matching error boundary without output mapping propagates all fail variables", func(t *testing.T) {
		...
		definitionKey := deploySequentialMultiInstanceErrorBoundaryVariablesDefinition(t, "testdata/multi_instance/sequential_multi_instance_service_task_with_error_boundary_event.bpmn", "sequential-multi-instance-error-boundary-variables")
	...
	t.Run("Matching error boundary output mapping propagates only mapped fail variables", func(t *testing.T) {
		...
		definitionKey := deploySequentialMultiInstanceErrorBoundaryVariablesDefinition(t, "testdata/multi_instance/sequential_multi_instance_service_task_with_error_boundary_event_and_output_mapping.bpmn", "sequential-multi-instance-error-boundary-variables-output-mapping")
		processInstance, multiInstanceProcess := createMultiInstanceErrorBoundaryVariablesProcessInstance(t, definitionKey, createInstanceVariables)
	...
	t.Run("Catch-all error boundary without output mapping propagates all fail variables", func(t *testing.T) {
		...
		definitionKey := deploySequentialMultiInstanceErrorBoundaryVariablesDefinition(t, "testdata/multi_instance/sequential_multi_instance_service_task_with_catch_all_error_boundary_event.bpmn", "sequential-multi-instance-error-boundary-variables-catch-all")
		processInstance, multiInstanceProcess := createMultiInstanceErrorBoundaryVariablesProcessInstance(t, definitionKey, createInstanceVariables)
...
func deploySequentialMultiInstanceErrorBoundaryVariablesDefinition(t *testing.T, filename string, processId string) int64 {
	t.Helper()
...
func createMultiInstanceErrorBoundaryVariablesProcessInstance(t testing.TB, definitionKey int64, variables map[string]any) (zenclient.ProcessInstance, zenclient.ProcessInstancesSimple) {
	t.Helper()
...
func multiInstanceErrorBoundaryExpectedBaseVariables() map[string]any {
