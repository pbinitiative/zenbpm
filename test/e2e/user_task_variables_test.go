...
func TestUserTaskVariables(t *testing.T) {
	...
	t.Run("If there are no mappings defined, the process variables remain unchanged", func(t *testing.T) {
		...
		processInstance := deployAndCreateUniqueProcessDefinition(t, "testdata/user_task/user_task_minimal.bpmn", createInstanceVariables)

		t.Cleanup(func() {
			cleanupOwnedProcessInstance(t, processInstance.Key)
		})

		assertFlowElementInputVariables(t, processInstance.Key, "user_task", createInstanceVariables)
		assertFlowElementOutputVariables(t, processInstance.Key, "user_task", nil)

		completeJobForElementId(t, processInstance.Key, "user_task", map[string]any{"variable_from_request_2": "request_var2"})
	...
	t.Run("Input mapping non-existing source variable assigns nil to target", func(t *testing.T) {
		...
		processInstance := deployAndCreateUniqueProcessDefinition(t, "testdata/user_task/user_task_with_input_missing_variable.bpmn", createInstanceVariables)
		...
		assertFlowElementInputVariables(t, processInstance.Key, "user_task", expectedInputVariables)
	...
	t.Run("Input mapping without a source definition assigns an empty string to the target", func(t *testing.T) {
		...
		createInstanceVariables := map[string]any{"variable_from_create_instance_1": "var1"}
		processInstance := deployAndCreateUniqueProcessDefinition(t, "testdata/user_task/user_task_with_input_mapping_without_source.bpmn", createInstanceVariables)
		...
		assertFlowElementInputVariables(t, processInstance.Key, "user_task", createInstanceVariablesWithInputVariable)
		assertFlowElementOutputVariables(t, processInstance.Key, "user_task", nil)
	...
	t.Run("Input-mapped variable is local and does not leak to process scope", func(t *testing.T) {
		...
		createInstanceVariables := map[string]any{"variable_from_create_instance_1": "var1"}
		processInstance := deployAndCreateUniqueProcessDefinition(t, "testdata/user_task/user_task_with_input_mapping.bpmn", createInstanceVariables)
	...
	t.Run("Input mapping with static value 'name:John' assigns literal to local variable", func(t *testing.T) {
		...
		processInstance := deployAndCreateUniqueProcessDefinition(t, "testdata/user_task/user_task_with_input_mapping_value_in_source.bpmn", nil)
		...
		assertFlowElementInputVariables(t, processInstance.Key, "user_task", inputVariable)
		assertFlowElementOutputVariables(t, processInstance.Key, "user_task", nil)
	...
	t.Run("Output mapping with static value 'name:John' writes literal to process scope", func(t *testing.T) {
		...
		processInstance := deployAndCreateUniqueProcessDefinition(t, "testdata/user_task/user_task_with_output_mapping_value_in_source.bpmn", nil)
		...
		assertFlowElementOutputVariables(t, processInstance.Key, "user_task", outputVariables)
	...
	t.Run("Output mapping with static value overwrites process variable", func(t *testing.T) {
		...
		processInstance := deployAndCreateUniqueProcessDefinition(t, "testdata/user_task/user_task_with_output_mapping_replace_process_variable.bpmn", createInstanceVariables)
		...
		assertFlowElementOutputVariables(t, processInstance.Key, "user_task", expectedOutputVariables)
	...
	t.Run("Output mapping reads input-mapped local variable and propagates value to the process instance", func(t *testing.T) {
		createInstanceVariables := map[string]any{"variable_from_create_instance_1": "var1"}
		processInstance := deployAndCreateUniqueProcessDefinition(t, "testdata/user_task/user_task_with_output_uses_input_local.bpmn", createInstanceVariables)
